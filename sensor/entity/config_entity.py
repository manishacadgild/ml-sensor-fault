...
class TrainingPipeLineConfig:
    ...
    def __init__(self):
        ...
        self.artifact_dir:str=os.path.join(training_pipeline.ARTIFACT_DIR,training_pipeline.TIMESTAMP)
        self.timestamp:str=training_pipeline.TIMESTAMP
...
class ModelEvaluationConfig:
    def __init__(self,training_pipeline_config:TrainingPipeLineConfig):
        self.model_evalution_dir:str=os.path.join(
